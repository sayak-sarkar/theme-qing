...
# as when run.
echo -e "
${BLUE#  }                 shhdhyo       ${fieldlist[0]}
${BLUE#  }              omMMMNNNMMMP)    ${fieldlist[1]}
${BLUE#  }             sMMMdo${GREEN#  }+++++++++   ${fieldlist[2]}
${BLUE#  }             MMMy      ${GREEN#  }++++++  ${fieldlist[3]}
${BLUE# }             MMM        ${YELLOW# }+++++  ${fieldlist[4]}
${YELLOW# }      ++++++${BLUE# }/+MM       ${YELLOW# }+++++   ${fieldlist[5]}
${RED#    }   +++++${BLUE# }oNMMMMMMMMMNho${RED#    }+++++    ${fieldlist[6]}
${RED#    }  +++++++${BLUE# }shhhMMMmhhy${RED#    }+++++      ${fieldlist[7]}
${RED#    } ++++++      ${BLUE# }MMMy              ${fieldlist[8]}
${PURPLE# } +++++       ${BLUE# }MMMy              ${fieldlist[9]}
${PURPLE# } ++++++     ${BLUE# }hMMM+              ${fieldlist[10]}
${BLUE#   }   dMMNdyydNMMNo               ${fieldlist[11]}
${BLUE#   }    sdNMMMMNds                 ${fieldlist[12]}
${BLUE#   }       'YY'                    ${fieldlist[13]}
 ${normal}
"
fi
